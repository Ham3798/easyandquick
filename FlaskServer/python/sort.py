...
meta = pd.read_csv('C:\\Users\\ham3798\\Documents\\python\\exam_metadata.csv')
meta.head()
...
ratings = pd.read_csv('C:\\Users\\ham3798\\Documents\\python\\ratings___small.csv')
...
a = pd.DataFrame(recommend_result, columns = ['Title', 'Correlation', 'Genre'])
print(a)